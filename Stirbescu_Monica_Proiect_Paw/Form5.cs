    ...
    public partial class Form5 : Form
    {
        ...
        private void Form5_Paint(object sender, PaintEventArgs e)
        {
            if (vb == true)
            {
                ...
                Rectangle rec = new Rectangle(this.ClientRectangle.X + margine, this.ClientRectangle.Y + 4 * margine, this.ClientRectangle.Width - 2 * margine, this.ClientRectangle.Height - 5 * margine);
                ...
                for (int i = 0; i < nrElem; i++)
                {
                    ...
                    g.DrawString(vect[i].ToString(), this.Font, br, new Point((int)(recs[i].Location.X + latime / 2), (int)(recs[i].Location.Y - font.Height)));
                }
                g.FillRectangles(br, recs);
                for (int i = 0; i < nrElem - 1; i++)
                {
                    g.DrawLine(pen, new Point((int)(recs[i].Location.X + latime / 2), (int)(recs[i].Location.Y)), new Point((int)(recs[i + 1].Location.X + latime / 2), (int)(recs[i + 1].Location.Y)));
                }
            }
        }

        private void toolStripMenuItemSchimbaCuloarea_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripMenuItemSchimbaFontul_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripMenuItemSalvare_Click(object sender, EventArgs e)
        {
